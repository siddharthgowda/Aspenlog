////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// load.js
// This file contains the scripts for the load page.
//
...
function doneLoadingWindLoads(zoneNum) {
  ...
  document
    ...
    .classList.remove("skeleton-loader");
  document
    .getElementById(`exposure-factor-rough-option-button-hz-${zoneNum}`)
    .classList.remove("skeleton-loader");
  document
...
function startLoadingWindLoads(i) {
  ...
  document
    .getElementById(`internal-pressure-category-enclosed-option-button-hz-${i}`)
    .classList.add("skeleton-loader");
  document
    .getElementById(
            ...
            fetch(`${connectionAddress}/get_height_zones`, requestOptions)
              ...
              .then((result) => {
                ...
                for (let zoneNum in heightZoneData) {
                  let innerZones =
                    heightZoneData[zoneNum]["wind_load"]["zones"];
...
function startLoadingSeismicLoads() {
  document
    .getElementById("amplification-factor")
    .classList.add("skeleton-loader");
  document
    .getElementById("response-modification-factor")
    .classList.add("skeleton-loader");
  document.getElementById("component-factor").classList.add("skeleton-loader");

  for (
    let i = 1;
    i < document.getElementById("seismic-load-table").rows.length - 1;
    i++
  ) {
...
function doneLoadingSeismicLoads() {
  ...
  document
    ...
    .classList.remove("skeleton-loader");
  document
    .getElementById("component-factor")
    .classList.remove("skeleton-loader");
...
function startLoadingSnowLoads() {
  document
    .getElementById("upwind-accumulation-factor")
    .classList.add("skeleton-loader");
  document
    .getElementById("downwind-accumulation-factor")
    .classList.add("skeleton-loader");
  document
    .getElementById("snow-load-upwind-uls")
    .classList.add("skeleton-loader");
  document
    .getElementById("snow-load-downwind-uls")
    .classList.add("skeleton-loader");
  ...
  window.api.invoke("get-connection-address").then((connectionAddress) => {
    window.api
      ...
      .then((token) => {
        ...
        if (
          roofTypeSelection ===
          "roof-selection-unobstructed-slippery-roof-option"
        ) {
        ...
        let radioButtons = document
          .getElementById("roof-type-selection")
    ...
    for (let i = 1; i <= numHeightZones; i++) {
      ...
      if (
        ...
        if (ceIntermediate === "") {
          ...
          document.getElementById("wind-calculate-warning").style.fontWeight =
            "bold";
          document.getElementById("wind-calculate-warning").innerHTML =
            "Please enter the ce intermediate for the intermediate exposure factor";
      ...
      if (
        ...
        document.getElementById("wind-calculate-warning").style.fontWeight =
          "bold";
        document.getElementById("wind-calculate-warning").innerHTML =
          "Please enter the topographic factor and select the exposure factor and internal pressure category for all the height zones";
...
document
  ...
  .addEventListener("click", () => {
    ...
    if (
      ...
      document.getElementById("seismic-calculate-warning").style.fontWeight =
        "bold";
      document.getElementById("seismic-calculate-warning").innerHTML =
        "Please enter the amplification factor, response modification factor and component factor";
...
document
  ...
  .addEventListener("click", async function () {
    ...
    // iterate through all snow load inputs and ensure no NA values are present
      ...
      document.getElementById("upwind-accumulation-factor").innerText ===
        "NA" ||
